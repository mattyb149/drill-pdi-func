...
package ninja.mattburgess.drill.pdi.func.kettle;
...
public class ChildFirstClassLoader extends URLClassLoader {
    ...
    static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ChildFirstClassLoader.class);

    private String name;

    public ChildFirstClassLoader( URL[] url, ClassLoader classLoader ) {
        super( url, classLoader );
    }

    public ChildFirstClassLoader( URL[] url, ClassLoader classLoader, String name ) {
